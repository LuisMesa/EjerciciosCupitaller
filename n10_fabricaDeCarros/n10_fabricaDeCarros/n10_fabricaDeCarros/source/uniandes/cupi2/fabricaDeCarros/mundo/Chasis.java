...
public abstract class Chasis extends Parte
{
     ...
     * @param pImagen Nombre de la Imagen que representa el chasis incluyendo la extensión (p.e. delanteraCompacto.png). pImagen!= null && pImagen != "".
     */
     ...
     * @param pAncho Ancho de la imagen. pAncho > 0.
     * @param pImagen Nombre del archivo con la figura. pImagen != null y pImagen != "".
