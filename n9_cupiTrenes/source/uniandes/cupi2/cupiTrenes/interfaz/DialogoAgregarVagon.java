...
public class DialogoAgregarVagon extends JDialog implements ActionListener
{
     ...
     */
    public DialogoAgregarVagon( InterfazCupiTrenes pPrincipal, int pCantidadParadas )
    {
        principal = pPrincipal;
        cantidadParadas = pCantidadParadas;
        setTitle( "Agregar Vagón" );
        ...
        panelAgregarParadas.setBorder( new TitledBorder( "Nuevo vagón" ) );
