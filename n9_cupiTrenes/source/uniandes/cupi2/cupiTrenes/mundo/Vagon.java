 ...
 * El número del vagón es mayor a 0.<br>
 */
public class Vagon implements Serializable
{
     ...
     * @param pCantidadSillas Cantidad de sillas disponibles en el vagón. pCantidadSillasDisponibles >= 0.
    ...
    public void cambiarSiguiente(Vagon pVagon)
    {
    	siguiente =pVagon;
    }
