 ...
 */
public class CupiTrenesTest extends TestCase
{
    // -------------------------------------------------------------
    // Constante
    // -------------------------------------------------------------
    ...
    public void testAgregarTren1( )
    {
        ...
        {
            // Caso de prueba 1.
            cupiTrenes.agregarTrenI( 35, paradas, horarios1 );
//            assertEquals( "No agrega el tren correctamente.", 35, cupiTrenes.darPrimerTren( ).darId( ) );

            // Caso de prueba 2.
            //System.out.println(cupiTrenes.darPrimerTren().darId());
            System.out.println(horarios2[0].toString());
            cupiTrenes.agregarTrenI( 40, paradas, horarios2 );
...
//            assertEquals( "No agrega el tren correctamente.", 35, cupiTrenes.darPrimerTren( ).darSiguiente( ).darId( ) );
            ...
            // Caso de prueba 3.
            cupiTrenes.agregarTrenI( 15, paradas, horarios4 );
//            assertEquals( "No agrega el tren correctamente.", 40, cupiTrenes.darPrimerTren( ).darId( ) );
...
//            assertEquals( "No agrega el tren correctamente.", 35, cupiTrenes.darPrimerTren( ).darSiguiente( ).darSiguiente( ).darId( ) );
            ...
            // Caso de prueba 4.
            cupiTrenes.agregarTrenI( 20, paradas, horarios3 );
//            assertEquals( "No agrega el tren correctamente.", 40, cupiTrenes.darPrimerTren( ).darId( ) );
//            assertEquals( "No agrega el tren correctamente.", 15, cupiTrenes.darPrimerTren( ).darSiguiente( ).darId( ) );
//            assertEquals( "No agrega el tren correctamente.", 35, cupiTrenes.darPrimerTren( ).darSiguiente( ).darSiguiente( ).darId( ) );
//            assertEquals( "No agrega el tren correctamente.", 20, cupiTrenes.darPrimerTren( ).darSiguiente( ).darSiguiente( ).darSiguiente( ).darId( ) );
            Tren actual = cupiTrenes.darPrimerTren();
            while(actual!=null)
            {
            	System.out.println(actual.darId()+ "   "+ actual.darHorarioSalida());
    ...
    public void testVenderTiquete1( )
    {
        ...
        try
        {
            ...
            assertEquals( "No vende el tiquete correctamente.", 50.0, cupiTrenes.darTotalRecaudo( ) );
            ...
            assertEquals( "No vende el tiquete correctamente.", 150.0, cupiTrenes.darTotalRecaudo( ) );
